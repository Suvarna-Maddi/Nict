      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-primary-100 max-w-sm leading-relaxed font-medium">
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-8 lg:col-span-2 sm:col-span-2">
            <div>
              ...
              <ul className="space-y-3 text-primary-200 font-medium">
            ...
            <div>
              ...
              <ul className="space-y-3 text-primary-200 font-medium">
                ...
                <li><Link to="/courses#c9" className="hover:text-white transition-colors">Java</Link></li>
                <li><Link to="/courses#c10" className="hover:text-white transition-colors">Python</Link></li>
                <li><Link to="/courses#c13" className="hover:text-white transition-colors">SQL</Link></li>
              </ul>
            </div>
          </div>
          <div className="lg:col-span-1">
            <h4 className="text-lg font-bold mb-4 text-white">Contact & Timings</h4>
            <ul className="space-y-3 text-primary-200 font-medium text-sm">
              <li className="flex items-start gap-2">
                <span className="shrink-0">📍</span>
                <a href="https://maps.app.goo.gl/6n5ehmVa5D7inBVV6" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
        ...
        <div className="border-t border-primary-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-primary-200 font-medium">
